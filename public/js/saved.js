// Saved jobs page: status tabs, search and sort, inline status changes, notes and removal
    ...
    return `
        <div class="job-row" data-id="${job._id}" style="--i: ${index}">
            <div class="row">
                ...
                <span class="mono muted cell-saved">${new Date(job.savedAt).toLocaleDateString(undefined, { day: 'numeric', month: 'short' })}</span>
