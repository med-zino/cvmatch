...
(function () {
    ...
    const STEPS = [
        ...
        { target: () => document.getElementById('alertCard'), title: 'Your daily email', text: 'Once your job titles and your CV are in, switch it on and pick a time. Every day we find new openings, score them against your CV and email you the top 3. Never the same job twice.' },
